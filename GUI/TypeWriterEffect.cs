...
public class TypeWriterEffect : MonoBehaviour
{
    ...
    void Update()
    {
        if(text_exit==true)
        {
            ...
            //GameObject.Find("Player").GetComponent<Player_Char>().isMovable = true;
    ...
    public void Get_Typing(int _dialog_cnt, string[] _fullText)
    {
        ...
        //GameObject.Find("Player").GetComponent<Player_Char>().isMovable = false;
